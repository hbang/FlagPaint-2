...
%ctor {
	...
	CFNotificationCenterAddObserver(CFNotificationCenterGetDarwinNotifyCenter(), NULL, (CFNotificationCallback)HBFPRelaunchSpringBoard, CFSTR("ws.hbang.flagpaint/RelaunchSpringBoard"), NULL, kNilOptions);
}
